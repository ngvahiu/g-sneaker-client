After cloning this project, using command ```npm install``` to install all necessary packages. In this app, I have used some notable packages: ``axios`` (for caling API), ``react-transition-group`` (for animations)
